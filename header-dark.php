...
<meta property="og:image" content="<?php echo get_theme_file_uri('/dist/images/Anchovies_Ourwork.gif') ?>" />
<meta property="og:video" content="<?php echo get_theme_file_uri('/dist/images/Anchovies_Ourwork.mp4') ?>" />
...
<header class="container">
    <div class="logo">
        ...
        <a href="/"><div class="logo_mobile"><img src="<?php echo get_theme_file_uri('/dist/images/Anchovies-black-mark.svg'); ?>"></div></a>
    </div>
    <div class="nav_open hoverswap">Menu</div>
    <div class="nav_wrap">
        <div class="nav_inner">
